...
public class KOI1998_J1 {
	...
	public static void main(String[] args) {
		...
		//matrix 정렬 , 변의 숫자가 앞이면 앞으로 오도록 하고 변의 숫자가 같을 경우 적은 숫자가 앞으로 가게 함
		...
		for (int i=0;i<half;i++) {
			...
			if (matrix[i][0] == 1 && matrix[i][2] ==1) {
				matrix[i][4] = 1;
			}
			if (matrix[i][0] == 1 && matrix[i][2] ==4) {
				matrix[i][4] = 2;
			}
			if (matrix[i][0] == 1 && matrix[i][2] ==2) {
				matrix[i][4] = 3;
			}
			if (matrix[i][0] == 1 && matrix[i][2] ==3) {
				matrix[i][4] = 4;
			}
			if (matrix[i][0] == 4 && matrix[i][2] ==4) {
				matrix[i][4] = 5;
			}
			if (matrix[i][0] == 2 && matrix[i][2] ==4) {
				matrix[i][4] = 6;
			}
			if (matrix[i][0] == 3 && matrix[i][2] ==4) {
				matrix[i][4] = 7;
			}
			if (matrix[i][0] == 2 && matrix[i][2] ==2) {
				matrix[i][4] = 8;
			}
			if (matrix[i][0] == 2 && matrix[i][2] ==3) {
				matrix[i][4] = 9;
			}
			if (matrix[i][0] == 3 && matrix[i][2] ==3) {
				matrix[i][4] = 10;
			}
